...
-- completion, and the :Blot* / :Blotter* registrations -- in one place. register(api)
...
-- Register every :Blot* / :Blotter* command, wiring its thin handler to the public
...
function M.register(api)
  ...
  register_parsed_command("BlotterToday", parse_day_offset, api.open_today)
  register_parsed_command("BlotterInit", parse_day_offset, api.init_day)
  register_parsed_command("BlotterNextDay", parse_step_count, api.open_relative_day)
