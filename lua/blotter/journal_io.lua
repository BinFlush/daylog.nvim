...
--
-- Reads, opens, scans, and seeds the dated journal files on disk (and their loaded
-- buffers). Distinct from the pure journal.lua, which is only path/date math.
...
M.journal_lines = journal_lines
M.journal_path_has_content = journal_path_has_content
M.existing_journal_dates = existing_journal_dates
M.expanded_journal_settings = expanded_journal_settings
M.can_abandon_current_buffer = can_abandon_current_buffer
M.open_journal_file = open_journal_file
M.edit_journal_file = edit_journal_file
M.current_buffer_journal_date = current_buffer_journal_date
