...
local function should_suppress_message(message)
  return type(message) == "string" and message:match("^daylog:")
end
...
dofile(root .. "/tests/logged_facts.lua")(t)
...
dofile(root .. "/tests/palette.lua")(t)
dofile(root .. "/tests/activity_hl.lua")(t)
dofile(root .. "/tests/timebar.lua")(t)
dofile(root .. "/tests/timebar_ui.lua")(t)
dofile(root .. "/tests/indicator.lua")(t)
dofile(root .. "/tests/quantize.lua")(t)
dofile(root .. "/tests/split.lua")(t)
dofile(root .. "/tests/summary_block.lua")(t)
dofile(root .. "/tests/render.lua")(t)
dofile(root .. "/tests/config.lua")(t)
dofile(root .. "/tests/text.lua")(t)
dofile(root .. "/tests/diagnostics.lua")(t)
dofile(root .. "/tests/daybook.lua")(t)
dofile(root .. "/tests/week.lua")(t)
dofile(root .. "/tests/export.lua")(t)
dofile(root .. "/tests/commit_audit.lua")(t)
dofile(root .. "/tests/commit_audit_install.lua")(t)
dofile(root .. "/tests/usecases.lua")(t)
dofile(root .. "/tests/rename_summary.lua")(t)
dofile(root .. "/tests/rename_range.lua")(t)
dofile(root .. "/tests/report_cursor.lua")(t)
dofile(root .. "/tests/report_rename.lua")(t)
dofile(root .. "/tests/report_log.lua")(t)
dofile(root .. "/tests/report_write.lua")(t)
dofile(root .. "/tests/balance_summary.lua")(t)
dofile(root .. "/tests/split_summary.lua")(t)
dofile(root .. "/tests/map_summary.lua")(t)
...
dofile(root .. "/tests/active_indicator.lua")(t)
dofile(root .. "/tests/stray_window.lua")(t)
dofile(root .. "/tests/core_commands.lua")(t)
dofile(root .. "/tests/daybook_commands.lua")(t)
dofile(root .. "/tests/keymaps.lua")(t)
dofile(root .. "/tests/keys.lua")(t)
dofile(root .. "/tests/undo.lua")(t)
dofile(root .. "/tests/auto_timezone.lua")(t)
dofile(root .. "/tests/autosave.lua")(t)
dofile(root .. "/tests/auto_summary.lua")(t)
...
dofile(root .. "/tests/sources_sync.lua")(t)
dofile(root .. "/tests/sources_picker.lua")(t)
dofile(root .. "/tests/sources_rank.lua")(t)
dofile(root .. "/tests/pick.lua")(t)
...
dofile(root .. "/tests/sources_wire.lua")(t)
...
dofile(root .. "/tests/robustness.lua")(t)
