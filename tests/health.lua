return function(t)
  ...
  t.test("health check reports core integration", function()
    ...
    t.ok(includes(reports.ok, ":DaylogRename is available"))
    t.ok(includes(reports.ok, ":DaylogMap is available"))
    t.ok(includes(reports.ok, ":DaylogBalance is available"))
    t.ok(includes(reports.ok, ":DaylogSplit is available"))
